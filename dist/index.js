...
function ScooreMiniMap({
  ...
  useEffect(() => {
    ...
    sourceMarkerRef.current = new mapbox.Marker({ element: el, anchor: "bottom" }).setLngLat([lng, lat]).addTo(map);
